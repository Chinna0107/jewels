...
export function Footer() {
  return (
    <footer className="bg-[#08183A] text-gray-50 pt-12 pb-24 md:pb-12 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 mt-2">
              {/* Facebook */}
              <a href="https://www.facebook.com/share/17AsQdiXcc/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ background: 'rgba(198,161,132,0.15)', color: '#C6A184' }}
                onMouseEnter={e => { e.currentTarget.style.background='#C6A184'; e.currentTarget.style.color='#08183A'; }}
                onMouseLeave={e => { e.currentTarget.style.background='rgba(198,161,132,0.15)'; e.currentTarget.style.color='#C6A184'; }}>
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/hourajewels?igsh=c2llNGRzM2RpbHZ3&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ background: 'rgba(198,161,132,0.15)', color: '#C6A184' }}
                onMouseEnter={e => { e.currentTarget.style.background='#C6A184'; e.currentTarget.style.color='#08183A'; }}
                onMouseLeave={e => { e.currentTarget.style.background='rgba(198,161,132,0.15)'; e.currentTarget.style.color='#C6A184'; }}>
              ...
              {/* YouTube */}
              <a href="https://youtube.com/@hourajewels?si=HPy2i7vmYLMjvauk" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ background: 'rgba(198,161,132,0.15)', color: '#C6A184' }}
                onMouseEnter={e => { e.currentTarget.style.background='#C6A184'; e.currentTarget.style.color='#08183A'; }}
                onMouseLeave={e => { e.currentTarget.style.background='rgba(198,161,132,0.15)'; e.currentTarget.style.color='#C6A184'; }}>
