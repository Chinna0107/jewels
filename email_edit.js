...
<head>
  ...
  <style>
    @media only screen and (max-width: 600px) {
      .responsive-container { margin: 10px auto !important; border-radius: 8px !important; }
      .responsive-pad { padding: 20px 15px !important; }
      .responsive-pad-bottom { padding: 0 15px 20px 15px !important; }
      .responsive-table th, .responsive-table td { padding: 8px 5px !important; font-size: 11px !important; }
      .stack-col { flex: 0 0 100% !important; min-width: 100% !important; box-sizing: border-box !important; margin-bottom: 15px !important; }
      .hide-mobile { display: none !important; }
    }
  </style>
</head>
<body style="margin:0;padding:0;background-color:#F5F5F7;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; -webkit-text-size-adjust: 100%;">
<div class="responsive-container" style="max-width:600px; width: 100%; margin: 20px auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 15px 35px rgba(0,0,0,0.05); box-sizing: border-box;">
  <!-- Header -->
  <div class="responsive-pad" style="background-color:#08183A; padding:35px 20px; text-align:center;">
    <img src="https://raw.githubusercontent.com/Chinna0107/jewels/main/src/assets/logo.png" alt="Houra Jewels Logo" style="height:55px;width:auto;margin-bottom:12px;" />
    <h1 style="color:#D4AF37; margin:0; font-family:serif; font-size:24px; font-weight:700; letter-spacing: 2px; text-transform: uppercase;">Houra Jewels</h1>
    <p style="color:#ffffff; margin: 8px 0 0 0; font-size: 11px; letter-spacing: 1px; font-weight: 300;">Wear it once, Love it for ever</p>
  </div>
  
  <!-- Greeting -->
  <div class="responsive-pad" style="padding:40px 30px 20px 30px; box-sizing: border-box;">
    <h2 style="color:#08183A; font-family:serif; font-size:20px; margin-top:0;">Thank You for Your Order! ✨</h2>
    <p style="color:#555; font-size:14px; line-height:1.6; margin-bottom:20px;">Hi ${escapeHtml(address.name || 'Customer')},</p>
    ...
    <!-- Order Meta -->
    <div style="background-color:#FDF8F0; border-radius:12px; padding:15px; margin-bottom:20px; display:flex; flex-direction: column; gap: 8px; box-sizing: border-box;">
      <div style="display:flex; justify-content:space-between; font-size: 13px; word-break: break-word;">
      ...
      <div style="display:flex; justify-content:space-between; font-size: 13px; word-break: break-word;">
        ...
        <strong style="color:#08183A; text-align: right;">${orderDate}</strong>
      </div>
      <div style="display:flex; justify-content:space-between; font-size: 13px; word-break: break-word;">
  ...
  <!-- Order Summary -->
  <div class="responsive-pad-bottom" style="padding:0 30px 20px 30px; box-sizing: border-box; overflow-x: auto;">
    <h3 style="color:#08183A; font-family:serif; font-size:16px; margin:0 0 15px 0; border-bottom: 2px solid #FDF8F0; padding-bottom: 10px;">ORDER SUMMARY</h3>
    <table class="responsive-table" style="width:100%; border-collapse:collapse; margin-bottom: 20px; box-sizing: border-box;">
      <thead>
        <tr>
    ...
    <table style="width:100%; border-collapse:collapse; margin-bottom: 20px;">
      <tr>
        <td class="hide-mobile" style="width: 20%;"></td>
        <td style="width: 100%;">
          <table style="width:100%; border-collapse:collapse;">
            <tr>
              <td style="padding: 6px 10px; color: #555; font-size: 13px; text-align: right;">Subtotal:</td>
              <td style="padding: 6px 10px; color: #08183A; font-size: 13px; text-align: right; font-weight: 600;">$${subtotal.toFixed(2)}</td>
            </tr>
            ${Number(discount) > 0 ? `<tr>
              <td style="padding: 6px 10px; color: #555; font-size: 13px; text-align: right;">Discount:</td>
              <td style="padding: 6px 10px; color: #059669; font-size: 13px; text-align: right; font-weight: 600;">-$${Number(discount).toFixed(2)}</td>
            </tr>` : ''}
            ...
            <tr>
              <td style="padding: 12px 10px; color: #08183A; font-size: 15px; text-align: right; font-weight: bold; border-top: 2px solid #FDF8F0;">Order Total:</td>
              <td style="padding: 12px 10px; color: #D4AF37; font-size: 16px; text-align: right; font-weight: bold; border-top: 2px solid #FDF8F0;">$${Number(total).toFixed(2)}</td>
            </tr>
          </table>
        </td>
      </tr>
  ...
  <!-- Payment & Shipping Details (Stacked) -->
  <div class="responsive-pad-bottom" style="padding:0 30px 20px 30px; display: block; box-sizing: border-box;">
    
    <div style="width: 100%; background-color: #fafafa; padding: 15px; border-radius: 12px; margin-bottom: 15px; box-sizing: border-box;">
      <h4 style="margin: 0 0 10px 0; color: #08183A; font-size: 13px; text-transform: uppercase; font-weight: bold;">Payment</h4>
    ...
    <div style="width: 100%; background-color: #fafafa; padding: 15px; border-radius: 12px; box-sizing: border-box;">
      <h4 style="margin: 0 0 10px 0; color: #08183A; font-size: 13px; text-transform: uppercase; font-weight: bold;">Shipping To</h4>
      <div style="font-size: 12px; color: #555; line-height: 1.6; word-break: break-word;">
  ...
  <div class="responsive-pad" style="padding: 30px; background-color: #FDF8F0; text-align: center; box-sizing: border-box;">
    <p style="color: #08183A; font-size: 13px; line-height: 1.6; margin: 0 0 20px 0;">
    ...
    <div style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 15px; display: inline-block; text-align: left; width: 100%; max-width: 400px; box-sizing: border-box;">
      <h4 style="margin: 0 0 8px 0; color: #D4AF37; font-size: 15px; font-family: serif;">✨ Jewelry Care Guide</h4>
    ...
    <h3 style="color: #08183A; font-family: serif; font-size: 16px; margin: 25px 0 0 0;">Thank you for supporting Houra Jewels! 💛</h3>
  </div>

  <!-- Footer -->
  <div class="responsive-pad" style="background-color: #ffffff; padding: 30px; text-align: center; border-top: 1px solid #f0f0f0; box-sizing: border-box;">
    <h4 style="color: #08183A; margin: 0 0 10px 0; font-size: 13px;">Questions?</h4>
    ...
    <p style="margin: 0 0 10px 0; font-size: 13px; font-family: serif; font-weight: bold; color: #08183A; letter-spacing: 1px;">HOURA JEWELS</p>
    <p style="margin: 0 0 20px 0; font-size: 11px; color: #888;">
    ...
    <p style="margin: 0 0 15px 0; font-size: 10px; color: #aaa;">
    ...
    <p style="margin: 0; font-size: 10px; color: #bbb;">&copy; 2026 Houra Jewels. All rights reserved.</p>
    <p style="margin: 5px 0 0 0; font-size: 9px; color: #ccc;">This is an automated order confirmation email. Please retain this email for your records.</p>
  </div>
</div>
</body>
</html>`;
